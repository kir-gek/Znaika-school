  ...
  const contacts = [
    {
      ...
      details: ["8 (499) 154-43-91", "info@znaika-school.ru"],
      color: "bg-blue-100 text-blue-600",
    },
    {
      icon: <Phone className="w-6 h-6" />,
      title: "Руководитель отдела приема",
      details: ["+7 (905) 149 99 03"],
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Наша команда готова ответить на все ваши вопросы и помочь с
            поступлением
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {contacts.map((contact, index) => (
            ...
            >
              <div
                className={`p-4 flex items-center justify-center ${contact.color}`}
              >
                <div className="p-3 rounded-full bg-white">{contact.icon}</div>
              </div>
              <div className="p-6">
